<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="ViewCart.aspx.cs" Inherits="ViewCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="wrap-header-cart js-panel-cart">
        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25">
            ...
            <div class="header-cart-content flex-w js-pscroll">
                <ul class="header-cart-wrapitem w-full" runat="server" id="ulCartList">
    ...
    <div class="container">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            <a href="ViewCart.aspx" class="stext-109 cl8 hov-cl1 trans-04">Cart
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
            <span class="stext-109 cl4">Address
            </span>
        </div>
    </div>
    
                       
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="CartDetailGetForFront" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="" Name="RId" SessionField="UserID" Type="Int64" />
        </SelectParameters>
    </asp:SqlDataSource>
                    ...
                    <div class="m-l-25 m-r--38 m-lr-0-xl">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CartId,ProductId" DataSourceID="SqlDataSource2"  CssClass="table table-bordered table-hover">
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Quantity">
                                        <ItemTemplate>
                                            <div class="row">
                                                <asp:ImageButton ID="ImageButton2" runat="server" Height="31px" ImageUrl="~/Images/minus.jpg" Width="28px" OnClick="ImageButton2_Click" />
                                           
                                                &nbsp;&nbsp;
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                &nbsp;&nbsp;
                                                 <asp:ImageButton ID="ImageButton1" runat="server" Height="25px" ImageUrl="~/Images/plus.jpg" OnClick="ImageButton1_Click" Width="25px" />
                        ...
                        <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                            <div class="flex-w flex-m m-r-20 m-tb-5">
                                <asp:TextBox ID="TextBox2" runat="server" CssClass="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"></asp:TextBox>
                                <%--<input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5" type="text" name="coupon" placeholder="Coupon Code">--%>
                                <div class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">
                                    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">Apply Coupan</asp:LinkButton>
                                </div>
                            </div>
                ...
                <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-b-13">
                            ...
                            <div class="size-209">
                                <%--<span class="mtext-110 cl2" runat="server" id="SubTotal">
                                </span>--%>
                                <asp:Label ID="lblSubTotal" runat="server" Text="Label" CssClass="mtext-110 cl2"></asp:Label>
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                <div class="p-t-15">
                                   ...
                                   <%-- <span class="stext-112 cl2" id="ship" runat="server">Calculate Shipping
                                    </span>--%>
                                    
                                    <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3" DataTextField="CityName" DataValueField="CityId" class="js-select2" ></asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="ListAllCity" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                    ...
                                    <div class="flex-w">
                                        <asp:LinkButton class="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Calculate Shipping</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="flex-w flex-t p-t-27 p-b-33">
                            ...
                            <div class="size-209 p-t-1">
                                <%--<span class="mtext-110 cl2" runat="server" id="NetTotal"> 
                                </span>--%>
                                <asp:Label ID="lblNetAmt" runat="server" Text="Label"></asp:Label>
                            </div>
                        </div>
                        <asp:LinkButton class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">
                            Proceed to checkout
