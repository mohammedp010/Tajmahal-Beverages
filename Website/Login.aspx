                    ...
                    <form id="form3" runat="server">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" placeholder="Email/Mobile Number" required></asp:TextBox>
                                <%--<input type="email" name="email" id="email" class="form-control" placeholder="email@example.com">--%>
                            </div>
                            <div class="form-group mb-4">
                                <label for="txtPassword">Password</label>
                                <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control" placeholder="enter your passsword" required></asp:TextBox>
                                <%--<input type="password" name="password" id="password" class="form-control" placeholder="enter your passsword">--%>
                            </div>
                           <%-- <input name="login" id="login" class="btn btn-block login-btn" type="button" value="Login">--%>
                            <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" CssClass="btn btn-block login-btn" />
                            
                        </div>
                        
                    </form>  
              
              <a href="ForgotPass.aspx" class="forgot-password-link">Forgot password?</a>
