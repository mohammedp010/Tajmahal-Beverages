...
<body>
    ...
    <div>
            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPass" runat="server" CssClass="form-control" placeholder="enter New Password" TextMode="Password" required></asp:TextBox><br />
                                <asp:TextBox ID="txtcnfPass" runat="server" CssClass="form-control" placeholder="Again!" TextMode="Password" required></asp:TextBox><br />
                                <asp:Button ID="btnSend" runat="server" Text="Change" CssClass="btn btn-primary" OnClick="btnSend_Click"   />
